...
# Open pdf file
pdfFileObj = open('/content/nlp_resume.pdf','rb')
...
#step3: Dictionary with key terms by area setup*
...
#Step4: Scores calculation per area
...
#Step5: Sorted data frame for final scores creation
# Create a data frame with the scores summary
summary = pd.DataFrame(scores,index=terms.keys(),columns=['score']).sort_values(by='score',ascending=False)
summary
#Step6: Pie chart creation
